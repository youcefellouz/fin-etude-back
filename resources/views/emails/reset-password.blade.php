...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .banner {
            background: linear-gradient(135deg, #0f172a 0%, #1e1b4b 50%, #be123c 100%);
...
<body>
    <div class="wrapper">
        ...
        <div class="card">
            ...
            <div class="body">
                <p class="intro">
                    Bonjour ! Vous avez demandé la réinitialisation de votre mot de passe sur <strong>TechShop Tunisia</strong>.<br>
